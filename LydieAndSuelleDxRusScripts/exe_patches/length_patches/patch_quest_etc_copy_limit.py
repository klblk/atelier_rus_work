#!/usr/bin/env python3
"""Apply quest objective UI copy limit patch (64 -> 128) to steamless exe."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--manifest",
        type=Path,
        default=QUEST_ETC_COPY_LIMIT_PATCHES_JSON,
    ...
    applied = apply_quest_etc_copy_limit_patch(exe)

    payload = {
        "copy_limit_patched": QUEST_COPY_LIMIT_PATCHED,
