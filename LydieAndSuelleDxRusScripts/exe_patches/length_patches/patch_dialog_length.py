#!/usr/bin/env python3
"""Apply dialog string buffer length patch (256 -> 512) to steamless exe."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--manifest",
        type=Path,
        default=DIALOG_LENGTH_PATCHES_JSON,
    ...
    applied = apply_dialog_length_patch(exe)

    payload = {
        "buf_limit_vanilla": DIALOG_BUF_MAX_VANILLA,
        "buf_limit_patched": DIALOG_BUF_MAX_PATCHED,
